...
def load_mnist(data_dir, W, iid, user_test=False):
    ...
    """
    train_x_fname = data_dir + '/MNIST/raw/train-images-idx3-ubyte.gz'
    train_y_fname = data_dir + '/MNIST/raw/train-labels-idx1-ubyte.gz'
    test_x_fname = data_dir + '/MNIST/raw/t10k-images-idx3-ubyte.gz'
    test_y_fname = data_dir + '/MNIST/raw/t10k-labels-idx1-ubyte.gz'
...
def load_cifar(data_dir, W, iid, user_test=False):
    ...
    """
    fnames = [  '/cifar-10-batches-py/data_batch_1', 
